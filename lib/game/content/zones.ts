...
export const ZONES: ZoneDefinition[] = [
  {
    ...
    heroSlots: 2,
    durationSec: 90,
    monsterPool: ["gobelin-eclaireur", "squelette", "chapardeur-halfelin"],
    statScale: 0.6,
    spawnIntervalSec: 3,
    baseWaveSize: 3,
    eliteEveryNWaves: 4,
  ...
  },
  {
    ...
    heroSlots: 3,
    durationSec: 100,
    monsterPool: ["gobelin-eclaireur", "golem-de-pierre", "orc-cuirasse", "ondin-eclaireur"],
    statScale: 0.8,
    spawnIntervalSec: 3,
    baseWaveSize: 3,
    eliteEveryNWaves: 3,
  ...
  },
  {
    ...
    heroSlots: 3,
    durationSec: 110,
    monsterPool: ["araignee-venimeuse", "gobelin-eclaireur", "golem-de-pierre", "orc-pillard", "elfe-archere"],
    statScale: 1,
    ...
    loot: {
      goldMin: 200,
      goldMax: 400,
      resourceDrops: { essence: [7, 18], ore: [6, 13] },
      itemDropChance: 0.35,
      monsterCaptureChance: 0.1,
  ...
  },
  {
    ...
    heroSlots: 4,
    durationSec: 120,
    monsterPool: ["araignee-venimeuse", "golem-de-pierre", "gobelin-eclaireur", "spectre-pourpre"],
    statScale: 1.4,
    spawnIntervalSec: 2.5,
    baseWaveSize: 5,
    eliteEveryNWaves: 2,
    ...
    loot: {
      goldMin: 350,
      goldMax: 650,
      resourceDrops: { essence: [13, 25], ore: [10, 19], wood: [10, 19] },
      itemDropChance: 0.45,
