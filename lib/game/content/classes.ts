...
// Two classes per role. Add more later by pushing another ClassDefinition
...
export const CLASSES: ClassDefinition[] = [
  {
    ...
    baseStats: { hp: 80, atkPhys: 16, atkMag: 2, defPhys: 6, defMag: 3, spd: 10 },
  ...
  },
  {
    ...
    baseStats: { hp: 60, atkPhys: 14, atkMag: 1, defPhys: 3, defMag: 2, spd: 16 },
    statGrowthPerLevel: { hp: 5, atkPhys: 2, atkMag: 0.1, defPhys: 0.3, defMag: 0.2, spd: 0.6 },
  },
  {
    id: "pretre",
    role: "HEAL",
    ...
    baseStats: { hp: 70, atkPhys: 1, atkMag: 8, defPhys: 4, defMag: 8, spd: 9 },
  ...
  },
  {
    ...
    baseStats: { hp: 85, atkPhys: 1, atkMag: 6, defPhys: 6, defMag: 7, spd: 8 },
  ...
  },
  {
    ...
    baseStats: { hp: 120, atkPhys: 8, atkMag: 3, defPhys: 12, defMag: 6, spd: 7 },
  ...
  },
  {
    ...
    baseStats: { hp: 150, atkPhys: 12, atkMag: 0, defPhys: 9, defMag: 2, spd: 6 },
